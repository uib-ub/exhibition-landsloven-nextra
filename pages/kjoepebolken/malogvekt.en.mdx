...
description: The Laws of the Land standardized the units of measurement and weight
tags:
  - laws of the land
  - trade
  - weights
...
alt: Silhouettes that show the sale of a product in a market.
---
...
<Blockquote
    quote='“And because it is so accepted in the entire country that the same steelyard and the equivalent weights and the equivalent scale weights and the equivalent measuring vessels and the equivalent measuring sticks are to be valid in the entire country, so that ignorant people are less likely to be fooled wherever they might arrive in the country.”'
...
<Figure
    ...
    title="Various weights from the exhibition. Photo: Olaf Knarvik"
    alt="Various weights from an exhibition showcase."
>
</Figure>
