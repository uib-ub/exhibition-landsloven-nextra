---
title: 'Tyvebolken'
description: 'Den siste bolken i Landsloven er Tyvebolken, som definerer tyveri og beskriver hvordan man stilte tyver til ansvar.'
tags:
  - tyveri
  - straff
...
<SubTextsCards items={site.tyvebolken} meta={meta} columns={2} gap={5}/>
...
<div className="flex grid gap-3 grid-cols-1 sm:grid-cols-3  p-0 my-3">
<Image
