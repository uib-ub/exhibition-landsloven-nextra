...
<Container>
     ...
     <Container>
         <span className="font-bold uppercase font-sans text-ll-blue-700">Kristendomsbolken</span> understreker verdien av den kristne tro, og rollen kristendommen skal ha i riket. 
